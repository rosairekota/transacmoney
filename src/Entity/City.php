...
class City
{
    ...
    public function getAbbrevName(): ?string
    {
        return $this->abbrev_name;
    }

    public function setAbbrevName(?string $abbrev_name): self
    {
